...
meaning requests are set-wise concurrent. But now direct-mapped means only
...
2.  **TLB (Translation Look-aside Buffer)**: **Set-Associative** because the
...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| _0_ | 03 | -  | **0** | 09 | 0D | **1** | 00 | -  | **0** | 07 | 02 | **1** |
| _1_ | 03 | 2D | **1** | 02 | -  | **0** | 04 | -  | **0** | 0A | -  | **0** |
| _2_ | 02 | -  | **0** | 08 | -  | **0** | 06 | -  | **0** | 03 | -  | **0** |
| _3_ | 07 | -  | **0** | 03 | 0D | **1** | 0A | 34 | **1** | 02 | -  | **1** |
...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| _00_ | 19 | **1** | 99 | 11 | 23 | 11 |
| _01_ | 15 | **0** | -  | -  | -  | -  |
| _02_ | 1B | **1** | 00 | 02 | 04 | 08 |
| _03_ | 36 | **0** | -  | -  | -  | -  |
| _04_ | 32 | **1** | 43 | 6D | 8F | 09 |
| _05_ | 0D | **1** | 36 | 72 | F0 | 1D |
| _06_ | 31 | **0** | -  | -  | -  | -  |
| _07_ | 16 | **1** | 11 | C2 | DF | 03 |
| _08_ | 24 | **1** | 3A | 00 | 51 | 89 |
| _09_ | 2D | **0** | -  | -  | -  | -  |
| _0A_ | 2D | **1** | 93 | 15 | DA | 3B |
| _0B_ | 0B | **0** | -  | -  | -  | -  |
| _0C_ | 12 | **0** | -  | -  | -  | -  |
| _0D_ | 16 | **1** | 04 | 96 | 34 | 15 |
| _0E_ | 13 | **1** | 83 | 77 | 1B | D3 |
| _0F_ | 14 | **0** | -  | -  | -  | -  |
...
### 🔹 **2. What field does the PTE store?**

Not a physical address — a PFN. Every page-table entry (PTE) does **not** store a full physical address.
...
###  🔥 **5. The clean, correct way to think about it**
...
| **"...kernel to provision data struct like `task_struct` and some of its fields like `pgd` and `mmap`..."** | **Initialization of Process Context** | The kernel creates the `task_struct` (the process descriptor) and its associated VM structures: the **Page Directory Base Register (CR3/PDBR)**, which points to the base of the Page Table (your `pgd`), and the **`mm_struct`** which contains the list of **Virtual Memory Areas (VMAs)** (your `mmap`). |
...
| **"...for the 'demand paging' to make good use of the scarce memory resource."** | **Demand Paging and Zeroing** | Upon the fault, the OS uses **Demand Paging** to fetch the necessary data (from the disk if File-Backed, or uses **Demand Zero** to fill with zeroes if Anonymous). Physical RAM is only consumed at this moment. |
...
the file. If it's dirty (implying the protection bit is `r/w`), it must first be written back to the file.
...
process. The process execution context (`task_struct`'s fields and resources)
is duplicated.
