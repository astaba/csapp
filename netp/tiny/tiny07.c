/* =========================================================================
 * Created on: <Fri Mar 27 15:08:40 +01 2026> 
 * Time-stamp: <Sat Apr  4 14:37:25 +01 2026 by owner> 
 * Author    : owner
 * Desc      : ~/coding/c_prog/csapp/netp/tiny/tiny07.c -
 *             tiny.c - A simple, iterative HTTP/1.0 Web server that uses
 *             the GET method to serve static and dynamic content.
 *
 * Problem 11.7: Extend Tiny so that it serves MPG video files.
 * Check your work using a real browser.
 * ========================================================================= */
#include "csapp.h"
...
int parse_uri(char *uri, char *filename, char *cgiargs) {
  ...
  if (!strstr(uri, "cgi-bin")) {
    ...
    strcpy(filename, "./public07");  /* begin convert1 */
