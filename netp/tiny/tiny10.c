/* =========================================================================
 * Created on: <Sun Mar 29 18:29:06 +01 2026>
 * Time-stamp: <Sun Mar 29 18:40:40 +01 2026 by owner>
 * Author    : owner
 * Desc      : ~/coding/c_prog/csapp/netp/tiny/tiny10.c -
 ...
 *    Your form should include two text boxes that users fill in with
 *    the two numbers to be added together. Your form should request
 *    content using the GET method.
 * B. Check your work by using a real browser to request the form from
...
int parse_uri(char *uri, char *filename, char *cgiargs) {
  ...
  if (!strstr(uri, "cgi-bin")) {
    ...
    strcpy(filename, "./public10");  /* begin convert1 */
