/* =========================================================================
 * Created on: <Fri Mar 27 17:13:29 +01 2026> 
 * Time-stamp: <Fri Mar 27 17:18:22 +01 2026 by owner> 
 * Author    : owner
 * Desc      : ~/coding/c_prog/csapp/ecf/ytfgets.c -
 * Problem 8.25
 * [[file:README.org::#problem-8-25]]
 * ========================================================================= */
...
static char *tfgets(char *s, int n, FILE *stream, int secs);
/* Signal handler for SIGALRM.
   It jumps back to tfgets context and makes sigsetjmp return 1. */
